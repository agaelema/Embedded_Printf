...
void main(void) {
	...
	BCSCTL1 = CALBC1_1MHZ;								// calibra o DCO
	DCOCTL = CALDCO_1MHZ;								// calibra o DCO
	...
	UCA0BR0 = 104;	// Calculo do baudrate // UCA0BR0 = clock/baud = 1MHz/9600
	UCA0BR1 = 0;	// Calculo do baudrate // UCA0BR0 = clock/baud = 1MHz/9600

	UCA0MCTL = UCBRS0;									// Modulation UCBRSx = 1
	UCA0CTL1 &= ~UCSWRST;// Desabilita o reset por software //Initialize USCI state machine
